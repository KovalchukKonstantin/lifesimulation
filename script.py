...
from business.producer import Producer
from random import randint
from business.human import Human
...
if __name__ == '__main__':
    ...
    if c == 'y':
        ...
        for i in range (1,p):
            a = Producer(i)
            players.append(a)
            graphic_pl.append(a.widget)
        player = Human(p)
        graphic_pl.append(player.widget)
